...
### EXPERIMENT 1 (NORMAL DISTRIBUTION WITH CORR MATRIX 1) ###
#############################################################
# Packages
...
library(DescTools) # package for implementing JT-test
...
at=c(1,2,3, 5,6,7, 9,10,11),par(mar=c(5,4,4,2)+0.1),main="RGA, RGR, RGF: Normal Distribution - Correlation matrix S1", 
...
at=c(1,2,3, 5,6,7, 9,10,11, 13,14,15),par(mar=c(5,4,4,2)+0.1),main="RGE: Normal Distribution - Correlation matrix S1", 
...
# RGF
# rand for > reg tree  > lin reg
pieces.RGF<-c(RGF_rf_mod_X1bin,RGF_reg_tree_X1bin,RGF_lin_reg_X1bin) 
n<-c(1000,1000,1000) 
grp.r<-as.ordered(factor(rep(1:length(n),n))) 
...
pieces.RGE_X1<-c(RGE_reg_tree_X1,RGE_rf_mod_X1,RGE_lin_reg_X1) 
n<-c(1000,1000,1000) 
grp.r<-as.ordered(factor(rep(1:length(n),n))) 
...
# Variable 2
# reg tree > rand for > lin reg
pieces.RGE_X2<-c(RGE_reg_tree_X2,RGE_rf_mod_X2,RGE_lin_reg_X2) 
n<-c(1000,1000,1000) 
grp.r<-as.ordered(factor(rep(1:length(n),n))) 
...
# Variable 4
#  reg tree > rand for > lin reg
pieces.RGE_X4<-c(RGE_reg_tree_X4,RGE_rf_mod_X4,RGE_lin_reg_X4) 
n<-c(1000,1000,1000) 
grp.r<-as.ordered(factor(rep(1:length(n),n))) 
