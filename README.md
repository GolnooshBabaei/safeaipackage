...
tive implementation. To fill the gap, Giudici and Raffinetti (2023) introduced a S.A.F.E.
...
are standardised, and have a common mathematical root: the Lorenz Zonoid tool (see, e.g.
Koshevoy and Mosler 1996; Lorenz 1905). Despite the advantages deriving from the S.A.F.E
...
governance sustainability (see, e.g. International Standard Organisation 2023).
...
concordance curves (see, e.g. Lorenz 1905; Giudici and Raffinetti 2011). This will allow to
